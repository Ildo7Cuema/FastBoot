          ...
          <div className="flex-1 flex flex-col overflow-y-auto">
            ...
            <div className="p-4 border-t border-gray-200 dark:border-gray-700">
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600 dark:text-gray-400">Dispositivos</span>
                  <span className="text-sm font-medium text-gray-900 dark:text-white">
                    {connectedDevices} conectado{connectedDevices !== 1 ? 's' : ''}
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="sticky top-0 z-10 flex-shrink-0 flex h-16 bg-white dark:bg-gray-800 shadow">
          ...
          <div className="flex-1 px-4 flex justify-between">
            ...
            <div className="ml-4 flex items-center space-x-4">
              ...
              <div className="flex items-center">
                {connected ? (
                  <CheckCircle className="h-5 w-5 text-green-500" title="Sistema Online" />
                ) : (
                  <AlertTriangle className="h-5 w-5 text-yellow-500" title="Sistema Offline" />
                )}
              </div>
            </div>
          </div>
